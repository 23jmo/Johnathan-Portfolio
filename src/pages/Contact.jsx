...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // console.log('Service ID:', import.meta.env.VITE_APP_EMAIL_JS_SERVICE_ID);
    // console.log('Template ID:', import.meta.env.VITE_APP_EMAIL_JS_TEMPLATE_ID);
